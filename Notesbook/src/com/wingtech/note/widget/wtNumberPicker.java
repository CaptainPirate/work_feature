...
public class wtNumberPicker extends LinearLayout {
    ...
    /**
     * Use a custom wtNumberPicker formatting callback to use two-digit minutes strings like "01". Keeping a static
    ...
    /**
     * Lower value of the range of numbers allowed for the wtNumberPicker
     */
    private int mMinValue;

    /**
     * Upper value of the range of numbers allowed for the wtNumberPicker
     */
    private int mMaxValue;

    /**
     * Current value of this wtNumberPicker
     */
    private int mValue;
    ...
    public interface OnValueChangeListener {
         ...
         * 
         * @param picker
         *            The wtNumberPicker associated with this listener.
         * @param oldVal
         *            The previous value.
         * @param newVal
         *            The new value.
         */
        void onValueChange(wtNumberPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChange(wtNumberPicker view, int scrollState);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            // / M: As the wtNumberPicker flings and layout changes occur at the
            // same time,
            // / we should skip initializeSelectorWheel() operation to avoid
            // abnormal display. @{
    ...
    private boolean moveToFinalScrollerPosition(Scroller scroller) {
        ...
        // / M: In some operatings, the scroller's currentY won't be updated. In
        // order to
        // / solve this issue, we need to update it by calling
                ...
                if (deltaMoveY <= mTouchSlop && deltaTime < ViewConfiguration.getTapTimeout()) {
                    if (mShowSoftInputOnTap) {
                        ...
                        if (selectorIndexOffset > 0) {
                            ...
                            // / M: Adjust wheel's position or the text will
                            // display abnormally
                            // / when tap on middle part of wtNumberPicker after
                            // fling.
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(wtNumberPicker.class.getName());
    ...
    /**
     * Sets the current value of this wtNumberPicker.
     * 
     * @param current
     *            The new value of the wtNumberPicker.
     * @param notifyChange
    ...
    /**
     * Updates the view of this wtNumberPicker. If displayValues were specified in the string corresponding to the index
    ...
    /**
     * Notifies the listener, if registered, of a change of the value of this wtNumberPicker.
     */
    ...
    protected void reInitiate(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
        SELECTOR_WHEEL_ITEM_COUNT = paramInt1;
        ...
        mSelectionDividersDistance = paramInt3;
        mNeedSoftInput = paramBoolean;
        mIsCustom = true;
    }
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            if (mDisplayedValues == null) {
                ...
                if (TextUtils.isEmpty(filtered)) {
                    // / M: Change language will cause onRestoreInstanceState
                    // bring previous state into mInputText,
                    // / it leads the string comparsion between source and
                    // mDisplayedValues being difference.
                    // / It should remove selection command if the string is
                    // empty after the comparsion.
                    if (mSetSelectionCommand != null) {
                        removeCallbacks(mSetSelectionCommand);
                    }
                    return "";
                ...
                // / M: Change language will cause onRestoreInstanceState bring
                // previous state into mInputText,
                // / it leads the string comparsion between source and
                // mDisplayedValues being difference.
                // / It should remove selection command if the string is empty
                // after the comparsion.
                if (mSetSelectionCommand != null) {
                    removeCallbacks(mSetSelectionCommand);
                }
                return "";
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            wtNumberPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            wtNumberPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void run() {
            ...
            case MODE_TAPPED: {
                ...
                case BUTTON_INCREMENT: {
                    if (!mIncrementVirtualButtonPressed) {
                        wtNumberPicker.this.postDelayed(this, ViewConfiguration.getPressedStateDuration());
                    }
                    mIncrementVirtualButtonPressed ^= true;
                    invalidate(0, mBottomSelectionDividerBottom, mRight, mBottom);
                }
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        public boolean performAction(int virtualViewId, int action, Bundle arguments) {
            ...
            case View.NO_ID: {
                ...
                case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                    if (wtNumberPicker.this.isEnabled() && (getWrapSelectorWheel() || getValue() < getMaxValue())) {
                        changeValueByOne(true);
                        return true;
                    }
                }
                ...
                case AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD: {
                    if (wtNumberPicker.this.isEnabled() && (getWrapSelectorWheel() || getValue() > getMinValue())) {
                        changeValueByOne(false);
                        return true;
                    }
                }
            ...
            case VIRTUAL_VIEW_ID_INPUT: {
                ...
                case AccessibilityNodeInfo.ACTION_FOCUS: {
                    if (wtNumberPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case AccessibilityNodeInfo.ACTION_CLICK: {
                    if (wtNumberPicker.this.isEnabled()) {
                        showSoftInput();
                        return true;
                    }
                    return false;
            ...
            case VIRTUAL_VIEW_ID_INCREMENT: {
                ...
                case AccessibilityNodeInfo.ACTION_CLICK: {
                    if (wtNumberPicker.this.isEnabled()) {
                        wtNumberPicker.this.changeValueByOne(true);
            ...
            case VIRTUAL_VIEW_ID_DECREMENT: {
                ...
                case AccessibilityNodeInfo.ACTION_CLICK: {
                    if (wtNumberPicker.this.isEnabled()) {
                        ...
                        wtNumberPicker.this.changeValueByOne(increment);
                        sendAccessibilityEventForVirtualView(virtualViewId, AccessibilityEvent.TYPE_VIEW_CLICKED);
                        return true;
                    }
                }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setSource(wtNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(wtNumberPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType, String text) {
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setEnabled(wtNumberPicker.this.isEnabled());
                event.setSource(wtNumberPicker.this, virtualViewId);
                requestSendAccessibilityEvent(wtNumberPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(wtNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId, String text,
            ...
            info.setSource(wtNumberPicker.this, virtualViewId);
            info.setParent(wtNumberPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(wtNumberPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top, int right,
                int bottom) {
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(wtNumberPicker.class.getName());
            info.setPackageName(mContext.getPackageName());
            info.setSource(wtNumberPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(wtNumberPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(wtNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(wtNumberPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
