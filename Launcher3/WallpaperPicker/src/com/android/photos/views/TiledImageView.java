...
public class TiledImageView extends FrameLayout {
    ...
    public void destroy() {
        ...
        if (USE_TEXTURE_VIEW) {
            ...
            mRenderer.image.finishAndWait();
        }
    }

    /**
     * Note: this method will be called in TileDecoder thread and queue a event
     * to GLThread for free texture. These textures may not be freed if GLThread
     * exist earlier and have no change to handle the queued event. Currently we
     * have no good way to guarantee that all queued event will be handled before
     * GLThread exist.
     */
