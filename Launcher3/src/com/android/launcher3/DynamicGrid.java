...
public class DynamicGrid {
    ...
    static float DEFAULT_ICON_SIZE_DP = 61;
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        String pkgname = Settings.Global.getString(context.getContentResolver(), "theme_package_name");
        if (pkgname == null) {
            pkgname = "com.wt.theme1";
        }
        //bug 196131 tangzhongfeng.wt MODIFY theme2 icon size 20160708
        if (pkgname.equals("com.wt.theme3")) {
            DEFAULT_ICON_SIZE_DP = 63;
        }

        DEFAULT_ICON_SIZE_PX = pxFromDp(DEFAULT_ICON_SIZE_DP, dm);
        // Our phone profiles include the bar sizes in each orientation
        // tangzhongfeng.wt MODIFY hasAA ? 3 : 4 to hasAA ? 3 : 5, 20160406  
        ...
        deviceProfiles.add(new DeviceProfile("Nexus S",
                ...
                R.xml.default_workspace_4x4_no_all_apps));
        /* disable Nexus 4 profile, for it has the same min width and min height with M823.
        deviceProfiles.add(new DeviceProfile("Nexus 4",
                335, 567,  4, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 5 : 5), 56, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        */
        //tangzhongfeng.wt MODIFY set app icon, hotseat icon the same size.  20160406
        deviceProfiles.add(new DeviceProfile("M823",
                335, 567,  5, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 5 : 4), DEFAULT_ICON_SIZE_DP, R.xml.default_workspace_5x4,
                R.xml.default_workspace_4x4_no_all_apps));
