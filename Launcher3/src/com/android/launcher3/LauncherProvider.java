...
public class LauncherProvider extends ContentProvider {
    ...
    private static final String PACKAGE_NAME_FOR_EMPTY_SCREEN = "empty_screen";
    ...
    private static long dbInsertAndCheck(DatabaseHelper helper,
        ...
        Log.i(TAG,"LYC: dbInsertAndCheck",new RuntimeException());
        Log.i(TAG,"LYC: values = " + values);
        if (values == null) {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        private void setFlagEmptyDbCreated() {
            ...
            // default page is the 3rd, index start from 0.
            int defaultWorkspaceIndex = mContext.getResources().getInteger(
                    R.integer.user_default_page_index);
            editor.putInt(Workspace.SP_KEY_USER_DEFAULT_SCREEN_INDEX, defaultWorkspaceIndex);
        ...
        private int loadFavorites(SQLiteDatabase db, WorkspaceLoader loader) {
            ...
            Log.d(TAG, "tzf loadFavorites count = " + count);
        ...
        private long addAppShortcut(SQLiteDatabase db, ContentValues values,
            ...
            if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(className)) {
                if (PACKAGE_NAME_FOR_EMPTY_SCREEN.equals(packageName)
                        && PACKAGE_NAME_FOR_EMPTY_SCREEN.equals(className)) {
                    return 1;
                }
                ActivityInfo info;
                try {
