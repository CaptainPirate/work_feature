...
public class SearchDropTargetBar extends FrameLayout implements
    ...
    private ButtonDropTarget mAppsManageDropTarget;
    ...
    public void setup(Launcher launcher, DragController dragController) {
        ...
        dragController.addDragListener(mCancelDropTarget);
        dragController.addDropTarget(mCancelDropTarget);
        mCancelDropTarget.setLauncher(launcher);

        dragController.addDragListener(mAppsManageDropTarget);
        dragController.addDropTarget(mAppsManageDropTarget);
        mAppsManageDropTarget.setLauncher(launcher);

        mDisableOriginalQsb = mQSBSearchBar == null;
    ...
    protected void onFinishInflate() {
        ...
        mCancelDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(R.id.cancel_target_text);
        mCancelDropTarget.setSearchDropTargetBar(this);

        mAppsManageDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(R.id.apps_manage_area);
        mAppsManageDropTarget.setSearchDropTargetBar(this);
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (!mIsSearchBarHidden && !mDisableOriginalQsb) {
            prepareStartAnimation(mQSBSearchBar);
            mQSBSearchBarAnim.start();
        }
    }
    ...
    public void onDragEnd() {
        if (!mDeferOnDragEnd) {
            ...
            if (!mLauncher.hasOpenedFolder() && !mLauncher.getWorkspace().isInIconManageOverviewMode()) {
