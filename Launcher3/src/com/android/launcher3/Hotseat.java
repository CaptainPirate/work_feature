...
public class Hotseat extends FrameLayout {
    ...
    private boolean mDisabledHotseatText;
    ...
    protected void onFinishInflate() {
        ...
        mDisabledHotseatText = grid.disableHotseatText;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        // the normal state.
        if (mLauncher.getWorkspace().workspaceInModalState() && mLauncher.getWorkspace().getState() != State.OVERVIEW_ICON_MANAGE) {
            return true;
        }
        return false;
    }
    ...
    public boolean isHotseatDisabled() {
        return mDisabledHotseatText;
    }
}
