...
public class DeviceProfile {
    ...
    int fixIconTextSize;
    int pageIndicatorMarginTopPx;

    boolean disableHotseatText;
    ...
    DeviceProfile(Context context,
        ...
        pageIndicatorMarginTopPx =
                res.getDimensionPixelSize(R.dimen.page_indicator_margin_top);
        ...
        iconManagePanelHeight = res.getDimensionPixelOffset(R.dimen.icon_manage_area_height);
        //bug 186273 tangzhongfeng.wt ADD 20160614
        editTempBgWidth = res.getDimensionPixelOffset(R.dimen.tempscreen_icon_size);
        ...
        folderColumns = res.getInteger(R.integer.folder_columns);
        folderRows = res.getInteger(R.integer.folder_rows);

        fixIconTextSize = res.getInteger(R.integer.launcher_text_size_in_sp);
        ...
        disableHotseatText = res.getBoolean(R.bool.disable_hotseat_text);
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources resources,
        ...
        iconTextSizePx = (int) (DynamicGrid.pxFromSp(fixIconTextSize, dm) * scale);
        iconDrawablePaddingPx = drawablePadding;
        //bug 186273 tangzhongfeng.wt ADD 20160614
        hotseatIconSizePx = iconSizePx;//(int) (DynamicGrid.pxFromDp(hotseatIconSize, dm) * scale);
        // Search Bar
        ...
        hotseatCellHeightPx = disableHotseatText ? iconSizePx : cellHeightPx;
        hotseatMarginBottom = resources.getDimensionPixelSize(R.dimen.hotseat_margin_bottom);

        // Folder
        folderCellWidthPx = cellWidthPx + 3 * edgeMarginPx;
        folderCellHeightPx = cellHeightPx + edgeMarginPx;
        //bug 172728 tangzhongfeng.wt MODIFY 20160505, 20160609
        folderBackgroundOffset = 10;//-edgeMarginPx;
        // bug 172728 tangzhongfeng.wt MODIFY 20160504, 20160609
        folderIconSizePx = iconSizePx - 2* (int) resources.getDimension(R.dimen.app_icon_shadow_padding);
        // All Apps
    ...
    int getSearchBarTopOffset() {
        // currently we don't have search bar.
        return 0;
        /*
        ...
        if (orientation == CellLayout.LANDSCAPE &&
            ...
            if (isTablet()) {
                ...
                padding.set(desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.left,
                        ...
                        hotseatBarHeightPx + 2 * pageIndicatorMarginTopPx + pageIndicatorHeightPx);
            }
        }
        return padding;
    }
    ...
    int getWorkspacePageSpacing(int orientation) {
        if ((orientation == CellLayout.LANDSCAPE &&
            ...
            // FIXME: we should consider widget default padding here
            return Math.min(defaultPageSpacingPx, 2 * getWorkspacePadding().left);
        }
    }
    ...
    Rect getIconManagePanelRect() {
        return new Rect(0, 0, Integer.MAX_VALUE, iconManagePanelHeight);
    }
    ...
    public void layout(Launcher launcher) {
        ...
        if (hasVerticalBarLayout) {
            ...
            searchBar.setPadding(0, getSearchBarTopOffset(), 0, 0);
        }
        ...
        if (hasVerticalBarLayout) {
            ...
            lp.gravity = Gravity.BOTTOM;
            // bug 198940 tangzhongfeng.wt ADD 20160720
            lp.bottomMargin = hotseatMarginBottom;
            lp.width = LayoutParams.MATCH_PARENT;
            lp.height = hotseatBarHeightPx;
            /*
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                lp.height = LayoutParams.WRAP_CONTENT;
                lp.bottomMargin = hotseatBarHeightPx + pageIndicatorMarginTopPx + hotseatMarginBottom;
        ...
        if (host != null) {
            ...
            if (pagedView != null) {
                ...
                padding.top = getSearchBarBounds(orientation).bottom;
        ...
        // Layout the CmccChildHiddenPanel
        ViewGroup childHidden = launcher.getChildHiddenPanel();
        if (childHidden != null) {
            lp = (FrameLayout.LayoutParams) childHidden.getLayoutParams();
            lp.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;

            int paddingHorizontal = widthPx / 4;
            int paddingVertical = res.getDimensionPixelSize(R.dimen.switch_effect_ok_button_margin_top);
            childHidden.setPadding(paddingHorizontal, paddingVertical, paddingHorizontal, paddingVertical);

            int childW = widthPx - 2 * paddingHorizontal;
            int childH = heightPx / 24;
            ((CmccChildHiddenPanel) childHidden).fixChildDimention(childW, childH);
        }
    }
}
