...
public class AppsCustomizeTabHost extends FrameLayout implements LauncherTransitionable, Insettable  {
    ...
    private void setVisibilityOfSiblingsWithLowerZOrder(int visibility) {
        ...
        View iconManageOverviewPanel = ((Launcher) getContext()).getIconManageHotseat();
        ...
        if (!isChildrenDrawingOrderEnabled()) {
            for (int i = 0; i < count; i++) {
                ...
                if (child == this) {
                    ...
                    if (child.getVisibility() == GONE || child == overviewPanel || child == iconManageOverviewPanel) {
                        continue;
                    }
