...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent data) {
        ...
        // some third-party app don't send correct data, avoid crash here.
        Bitmap icon = null;
        ...
        try {
            ...
            Log.e(TAG, "install shortcut intent has wrong data type, ignore.");
            return;
        }
    ...
    static void flushInstallQueue(Context context) {
        ...
        if (!installQueue.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                //bug 197142 tangzhongfeng.wt ADD 20160712
                if (LauncherAppState.isDisableAllApps()
                        && LauncherModel.applicationExists(context, name, intent)) {
                    Log.d(TAG, "install shortcut exist");
                    continue;
                }
            ...
            if (!addShortcuts.isEmpty()) {
                LauncherAppState app = LauncherAppState.getInstance();
                app.getModel().addAndBindAddedWorkspaceApps(context, addShortcuts, true);
            }
        }
    }
