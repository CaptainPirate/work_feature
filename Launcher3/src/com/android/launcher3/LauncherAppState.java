...
import com.android.launcher3.effect.EffectManager;
...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    private CmccUnreadInfoManager mUnreadInfoManager;
    
    private boolean mLauncherInEdit;
    ...
    private LauncherAppState() {
        ...
        mUnreadInfoManager = new CmccUnreadInfoManager(this);
    }
    ...
    LauncherModel setLauncher(Launcher launcher) {
        ...
        EffectManager.getInstance().setLauncher(launcher);
        CmccDynamicCalendar.getInstance().setLauncher(launcher);
        return mModel;
    }
    ...
    public CmccUnreadInfoManager getUnreadInfoManager() {
        return mUnreadInfoManager;
    }
    
    /*tangzhongfeng.wt add 20160418 start*/
    public void setLauncherInEdit(boolean inEdit) {
        mLauncherInEdit = inEdit;
    }

    public boolean getLauncherInEdit() {
        return mLauncherInEdit;
    }
    /*tangzhongfeng.wt add 20160418 end*/
}
