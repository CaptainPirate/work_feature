...
public final class IntentsActionPolicy extends ActionsPolicy {
    ...
    public static void sendFileSystemObject(
        ...
        ///:[ICE15-1680]--modify@{
            Uri uri = getUriForFile(ctx, new File(fso.getFullPath()));
        ///:--@}
...
///:[ICE15-1680]--modify@{
    public static Uri getUriForFile(Context context, File file) {
        ...
        Uri uri;
        Log.d(TAG, "hss getUriForFile"); 
        if (Build.VERSION.SDK_INT >= 24) {
        Log.d(TAG, "hss1"); 
            uri = FileProvider.getUriForFile(context.getApplicationContext(), "com.cyanogenmod.filemanager.fileprovider", file);
        } else {
        Log.d(TAG, "hss2"); 
