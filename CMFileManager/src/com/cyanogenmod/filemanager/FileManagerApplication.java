...
public final class FileManagerApplication extends Application {
    ...
    private static void readSystemProperties() {
        //modified by gehuaishu for ICE2-1552 avoiding resource leaks start
        InputStream is = null;
        try {
            String propsFile =
                    getInstance().getApplicationContext().getString(R.string.system_props_file);
            Properties props = new Properties();
            is = new FileInputStream(new File(propsFile));
            props.load(is);
        ...
        //modified by gehuaishu for ICE2-1552 avoiding resource leaks end
    }
