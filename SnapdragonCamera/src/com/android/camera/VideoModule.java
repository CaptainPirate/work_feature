...
public class VideoModule implements CameraModule,
    ...
    //modify by zhangpanpan ICE2-2264 maxFileSize fault cause video record keeping
    ...
    //add by muxudong for ICE2-775 start
    private boolean mIsAfterRecording = false;
    //add by muxudong for ICE2-775 end
    ...
    private class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //modified by muxudong for ICE2-1787 end
        }
    }
    ...
    private void initializeVideoControl() {
        ...
        //add by muxudong for ICE2-775 start
        if (isVideoCaptureIntent() && mIsAfterRecording) {
    ...
    private void onStopVideoRecording() {
        ...
        //add by lichao for ICE2-1144,2017-5-31 start
        if (recordFail) {
            RotateTextToast.makeText(mActivity,
                        mActivity.getResources().getString(R.string.video_record_fail),
                                Toast.LENGTH_SHORT).show();
            mUI.enableShutter(true);
        }
        //add by lichao for ICE2-1144,2017-5-31 end
    ...
    //add by muxudong for ICE2-1082,2017-5-28 start
    @Override
    public void switchSavePathToPhone(){
        mUI.setPreference(CameraSettings.KEY_CAMERA_SAVEPATH, "0");
    }
    //add by muxudong for ICE2-1082,2017-5-28 end
    ...
    private void saveVideo() {//在 stopVideoRecording() 之后调用
        if (mVideoFileDescriptor == null) {
            ...
            //modify by weiyuanfei for ICE15-971
    ...
    private boolean startVideoRecording() {//开始录像
        ...
        if (mUnsupportedHSRVideoSize == true) {
            ...
            //add by wangshenxing [ICE2-1290] 2017/06/05 start
            String HighFrameRate = mPreferences.getString(
                CameraSettings.KEY_VIDEO_HIGH_FRAME_RATE,
                mActivity. getString(R.string.pref_camera_hfr_default));
            String videoQuality = mPreferences.getString(CameraSettings.KEY_VIDEO_QUALITY,
            ...
            if (HighFrameRate.equals("hsr90") && videoQuality.equals("1280x720")) {
                RotateTextToast.makeText(mActivity,R.string.error_app_unsupported_hsr90,
                        Toast.LENGTH_SHORT).show();
            } else if (HighFrameRate.equals("hsr120") && videoQuality.equals("1280x720")) {
                RotateTextToast.makeText(mActivity,R.string.error_app_unsupported_hsr120,
                        Toast.LENGTH_SHORT).show();
            } else {
                RotateTextToast.makeText(mActivity,R.string.error_app_unsupported_hsr,
                        Toast.LENGTH_SHORT).show();
            }
            //add by wangshenxing [ICE2-1290] 2017/06/05 end
            mStartRecPending = false;
            return false;
        }
    ...
    private boolean stopVideoRecording() {
        ...
        if (mMediaRecorderRecording) {
            ...
            try {
				...
				mUI.enableShutter(true); // add for ICE15-693
