...
public class CameraSettings {
    ...
    public static final String KEY_TS_MAKEUP_PARAM         = "tsmakeup"; // On/Off
    ...
    public static final String KEY_TS_MAKEUP_LEVEL_EYE     = "pref_camera_arcmakeup_eye";
    public static final String KEY_TS_MAKEUP_LEVEL_FACE    = "pref_camera_arcmakeup_face";
    public static final String KEY_TS_MAKEUP_PARAM_EYE     = "arcbeauty_eye_enlargement"; // 0~100
    public static final String KEY_TS_MAKEUP_PARAM_FACE    = "arcbeauty_face_slender";  // 0~100
   ...
   public static int getHighSpeedQualityFor(int quality) {
	...
	if(mCameraId == 0){//ICE15-1841/ICE15-1842
   ...
   public static List<String> getSupportedFlipMode(Parameters params){
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        //add by zhangpengfei for ICE2-253 build HFR start
        if (videoHfrMode != null) {
            if (isFrontCamera || (mParameters.getSupportedHfrSizes() == null))
                filterUnsupportedOptions(group, videoHfrMode, null);
        }
        //add by zhangpengfei for ICE2-253 build HFR end

        //add by wangshenxing [ICE2-850] 2017/05/24 start
        removePreference(group, KEY_SHUTTER_SOUND);
        //add by wangshenxing [ICE2-850] 2017/05/24 end
