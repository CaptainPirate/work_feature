...
public class PhotoUI implements PieListener,
    ...
    //add by muxudong for ICE2-1194 start
    private boolean isCaptureHandled = false;
    //add by muxudong for ICE2-1194 end
    ...
    public PhotoUI(CameraActivity activity, PhotoController controller, View parent) {
        ...
        mSwitchMain.setCurrentIndex(HorizontalselectedView.PHOTO_MODULE_INDEX);
    ...
    //add by muxudong for ICE2-1194 start
    public boolean getCaptureHandled() {
        return isCaptureHandled;
    }

    public void setCaptureHandled(boolean handled) {
        isCaptureHandled = handled;
    }
    //add by muxudong for ICE2-1194 end
    ...
    //add by zhangpengfei for ICE2-236 hidden beauty icons when press the volume key
    public void hideMakeupUI() {
        //add by wangshenxing for ICE2-1011 2017/05/25 start
        if (mMenu != null) {
            mMenu.animateSlideOutPreviewMenu();
        }
        //add by wangshenxing for ICE2-1011 2017/05/25 end
    }
}
