...
public class VideoUI implements PieRenderer.PieListener,
    ...
    private FrameLayout mVideoPauseButton;
    ...
    public VideoUI(CameraActivity activity, VideoController controller, View parent) {
        ...
        //:iphone style --start--@{
        mSwitchMain =  (HorizontalselectedView)mRootView.findViewById(R.id.switch_main);
        mSwitchMain.setCurrentIndex(ModuleSwitcher.VIDEO_MODULE_INDEX);
        mSwitchMain.setHorizontalSwitchListener(mActivity);
        //:--end--@}
        ...
        if (com.huaqin.common.featureoption.FeatureOption.HQ_1520_AMAZON_MODIFY_FLASHMODE_UI) {
            ((ViewGroup)mRootView).removeView(mVideoPauseButton);
        }
        //add by muxudong for ICE2-357 camera UI end
    }
    ...
    ///:iphone style start
    public void setmainSwitcherIndex() {
        mSwitchMain.setCurrentIndex(HorizontalselectedView.VIDEO_MODULE_INDEX);
    }
    ///:iphone style end
...
// no customvideo?
    ...
    private void initializeOverlay() {
        ...
        if (com.huaqin.common.featureoption.FeatureOption.HQ_1520_SECURE_CAMERA_SHOW_THUMBNAIL || !mActivity.isSecureCamera()) {
    ...
    private void initializeMiscControls() {
        ...
        //add by muxudong for ICE2-357 camera UI start
        if (com.huaqin.common.featureoption.FeatureOption.HQ_1520_AMAZON_MODIFY_FLASHMODE_UI) {
            mVideoPauseButton = (FrameLayout) mRootView.findViewById(R.id.rotate_video_pause);
        }
        //add by muxudong for ICE2-357 camera UI end
    ...
    public void showRecordingUI(boolean recording) {
        ...
        if (recording) {
            ...
            //add by muxudong for ICE2-357 camera UI start
            if (com.huaqin.common.featureoption.FeatureOption.HQ_1520_AMAZON_MODIFY_FLASHMODE_UI) {
                changeMuteButtonLocation(4);
                ((ViewGroup)mRootView).addView(mVideoPauseButton);
            }
            //add by muxudong for ICE2-357 camera UI end
    ...
    //add by muxudong for ICE2-357 camera UI start
    private void changeMuteButtonLocation(int x) {
        int rotation = CameraUtil.getDisplayRotation(mActivity);
        int idx1 = rotation / 90;
        mMuteButton.setX(mCameraControls.getLocX(idx1, x));
        mMuteButton.setY(mCameraControls.getLocY(idx1, x));
    }
    //add by muxudong for ICE2-357 camera UI end
    ...
    public void setOrientation(int orientation, boolean animation) {
        ...
        //add by muxudong for ICE2-357 camera UI start
         if (com.huaqin.common.featureoption.FeatureOption.HQ_1520_AMAZON_MODIFY_FLASHMODE_UI
                && mPauseButton != null) {
            mPauseButton.setOrientation(orientation, false);
        }
        //add by muxudong for ICE2-357 camera UI end
